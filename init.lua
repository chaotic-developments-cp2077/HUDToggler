...
local HUDSettingGroupPath = "/interface/hud"
...
local function drawMenu()
  if not isCETOpen then return end
...
local function syncManagedSettings()
...
registerForEvent("onInit", function()
  local HUDSettingsGroup = GameSettings.GetSettingsGroup(HUDSettingGroupPath)
